...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(WorkingSet_0), TYPEID_WORKSET, COLOR(187), 1, ID(DataMask_Home), 1, 0, 2,
		...
		'e', 'n',
		'd', 'e',
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(235), ID(SoftKeyMask_Home), 7, 0, 
		XYREF(Container_Tageszaehler, 202, 5),
		XYREF(Meter_Tageszaehler, 226, 266),
		XYREF(OutputString_ZielErreicht, 500, 150),
		XYREF(Container_Gesamtzaehler, 5, 5),
		XYREF(Meter_Gesamtzaehler, 27, 266),
		XYREF(Button_MinusMinus, 400, 393),
		XYREF(Button_PlusPlus, 400, 306),
	...
	ID(Button_PlusPlus), TYPEID_BUTTON, WORD(80), WORD(80), 11, 6, 1, 0, 1, 0, 
	...
	ID(Button_MinusMinus), TYPEID_BUTTON, WORD(80), WORD(80), 12, 5, 1, 0, 1, 0, 
