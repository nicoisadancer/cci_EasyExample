...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Button_S2), TYPEID_BUTTON, WORD(80), WORD(71), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_Seite2, -4, 22),
		MACRO(EV_KEYRELEASE, Macro_1),
	ID(Button_6005), TYPEID_BUTTON, WORD(211), WORD(169), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_Seite_2, -4, 71),
	...
	ID(OutputString_Seite2), TYPEID_OUTSTR, WORD(80), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(7), 'S', 'e', 'i', 't', 'e', '_', '2', 0,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_Seite_2), TYPEID_OUTSTR, WORD(211), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(6), 'S', 'e', 'i', 't', 'e', '1', 0,
