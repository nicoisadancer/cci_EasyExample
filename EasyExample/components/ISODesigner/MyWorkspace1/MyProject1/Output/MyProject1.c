...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(zuHauptseite), TYPEID_MACRO, WORD(8),
		CMD_CHANGE_ACTIVE_MASK, ID(WorkingSet_0), ID(DataMask_Home), 0xFF, 0xFF, 0xFF,
	ID(ausblenden), TYPEID_MACRO, WORD(8),
		CMD_HIDE_SHOW, ID(Container_Tageszaehler), False, 0xFF, 0xFF, 0xFF, 0xFF,
	ID(einblenden), TYPEID_MACRO, WORD(8),
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 9, 0, 
		...
		XYREF(Button_EIN, 400, 99),
	ID(Seite_2), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 1, 0, 
		XYREF(Button_6005, 351, 383),
	ID(Seite3), TYPEID_DATAMASK, COLOR_GREEN, ID(ID_NULL), 2, 0, 
		XYREF(Button_6007, 304, 225),
		XYREF(Button_6008, 304, 332),
	ID(Container_Gesamtzaehler), TYPEID_CONTAINER, WORD(191), WORD(470), 0, 7, 0, 
	...
	ID(Container_Tageszaehler), TYPEID_CONTAINER, WORD(191), WORD(470), 0, 7, 0, 
		XYREF(Rectangle_Box, 0, 0),
	...
	ID(Button_S2), TYPEID_BUTTON, WORD(80), WORD(71), 11, 9, 1, 0, 1, 1, 
		...
		MACRO(EV_KEYRELEASE, Seite2),
	ID(Button_6005), TYPEID_BUTTON, WORD(116), WORD(85), 5, 9, 1, 0, 1, 1, 
		XYREF(OutputString_Seite_2, -19, 32),
		MACRO(EV_KEYRELEASE, Seite1),
	ID(Button_EIN), TYPEID_BUTTON, WORD(71), WORD(70), 3, 4, 1, 0, 1, 2, 
		XYREF(OutputString_11007, -4, 21),
		MACRO(EV_KEYPRESS, ausblenden),
		MACRO(EV_KEYRELEASE, einblenden),
	ID(Button_6007), TYPEID_BUTTON, WORD(165), WORD(85), 39, 9, 1, 0, 1, 1, 
		XYREF(OutputString_Hauptseite, 6, 28),
		MACRO(EV_KEYRELEASE, zuHauptseite),
	ID(Button_6008), TYPEID_BUTTON, WORD(146), WORD(95), 249, 249, 1, 0, 1, 0, 
		XYREF(OutputString_11013, -4, 34),
	...
	ID(OutputString_11007), TYPEID_OUTSTR, WORD(71), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(7), 'E', 'I', 'n', '_', 'A', 'U', 'S', 0,
	ID(OutputString_Hauptseite), TYPEID_OUTSTR, WORD(145), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(10), 'H', 'a', 'u', 'p', 't', 's', 'e', 'i', 't', 'e', 0,
	...
	ID(OutputString_11013), TYPEID_OUTSTR, WORD(146), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
